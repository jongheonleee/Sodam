const subscriptions = [
    {
        ...
        title: "BRONZE",
        summary: "BRONZE 구독권입니다. 구독자 전용 게시글을 총 50번 읽을 수 있고 \n 최대 15번까지 다운로드할 수 있습니다.",
        discCost: 3000,
        cost: 15000,
        saleCost: 12000
    },
    {
        ...
        title: "SILVER",
        summary: "SILVER 구독권입니다. 구독자 전용 게시글을 총 100번 읽을 수 있고 \n 최대 30번까지 다운로드할 수 있습니다.",
        discCost: 3000,
        cost: 15000,
        saleCost: 12000
    },
    {
        ...
        title: "GOLD",
        summary: "GOLD 구독권입니다. 구독자 전용 게시글을 무제한으로 읽고 다운로드할 수 있습니다.",
        discCost: 3000,
        cost: 15000,
        saleCost: 12000
    },
                    ...
                    subscriptions?.map((subscription) => (
                        <div className="subscription__box">
                            ...
                            <div className="subscription__info">
                                ...
                                <button className="subscription__buy-btn">구매</button>
                            </div>
                        </div>
                    ))
                ) : (
