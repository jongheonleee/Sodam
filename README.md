...
- ### [5. 카카오톡 소셜 로그인 기능 구현 →OAuth2.0 적용](https://www.notion.so/5-Sodam-OAuth2-0-2003fdd0e2e780e5a578f429cd50f94e)
- ### [6. 비효율적인 결제 이력 조회 및 저장하는 구조 → Elastic Search와 Kafka를 활용하여 개선](https://www.notion.so/6-Sodam-Elastic-Search-Kafka-2013fdd0e2e780e89a0ece2451b443a3)
<br>
...
> - ### 3. 시스템 아키텍처 설계
>   ![서비스 아키텍처 구조](./docs/design/sodam-시스템-아키텍처.png)
> - AWS 3-Tier 아키텍처를 기반으로 **시스템의 안정성과 고용성을**을 목표로 설계했습니다.
> - **Master RDB에는 DML 쿼리 요청을 담당, Slave RDB에는 Select 요청 전송하도록 구성하여 부하 분산시킬 계획입니다.**
> - 현재 초기 설계 도안(Kafka, Elastic Search 적용되지 않은 버전)입니다. AWS기반으로 DevOps와 클라우드를 공부하고 있으며 동시에 학습한 내용을 바탕으로 설계도 만들고 서비스에 적용하고 있습니다.</strong>
