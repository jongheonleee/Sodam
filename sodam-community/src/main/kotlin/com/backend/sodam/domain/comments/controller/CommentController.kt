...
class CommentController(
    ...
    fun create(
        ...
        return SodamApiResponse.ok(createCommentUseCase.create(articleId, commentCreateRequest.toCommand(userId)))
    }
    ...
    fun getComment(
        ...
        return SodamApiResponse.ok(fetchCommentUseCase.getSimpleComment(commentId))
    }
    ...
    fun update(
        ...
        val userId = tokenProvider.getUserId()
        return SodamApiResponse.ok(updateCommentUseCase.update(commentId, commentUpdateRequest.toCommand(userId)))
    }
    ...
    fun delete(
        ...
        val userId = tokenProvider.getUserId()
        return SodamApiResponse.ok(deleteCommentUseCase.delete(userId, commentId))
    }
}
